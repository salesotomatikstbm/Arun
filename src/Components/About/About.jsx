      ...
      <section className="about__section pt-120 pb-120" id="about">
        <div className="container">
          <div className="personal__head text-center">
            ...
            I'm Arun, a React Developer with 3 years of experience. I specialize in building dynamic and scalable web applications. Passionate about crafting seamless user experiences, I am ready to take on any development challenge.
            </p>
          </div>
